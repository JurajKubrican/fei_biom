...
def main():
    ...
    array_of_z = test_all_iris(images,masks)     #vytvori pole vsetkych z hodnot s tym ze index hodnoty v poli je index obrazkov x*y++ (1*2,1*3,1*4... #rovnake indexy preskakuje
